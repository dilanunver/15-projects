...
form.addEventListener('submit', function(e){
  e.preventDefault()
  //console.log('hello') // if you would not write preventDefault, hello goes fast, just it is seen while you are clicking generate button.
  const value = parseInt(amount.value);
 // console.log(value) // it looks like empty, but if you write on parag, you can see the number on console as a black. 
  //console.log(typeof value) // it is a string 
  //console.log(isNaN(value)) true - false
